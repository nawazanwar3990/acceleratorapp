<div class="row">
    <div class="mb-3 col-12">
        ...
        {!! Form::select('menu_type',\App\Services\CMS\MenuService::getTypes(),null,['class' => 'form-control','id' => 'header_logo','placeholder'=>trans('general.select')]) !!}
    </div>
    ...
    <div class="mb-3 col-6">
        {!!  Html::decode(Form::label('favicons_logo' ,__('general.favicon'),['class'=>'col-form-label']))   !!}
        {!! Form::file('favicons_logo', ['class' => 'form-control dropify','id' => 'favicons_logo','data-default-file'=>asset($model->favicons_logo)]) !!}
    </div>
</div>
