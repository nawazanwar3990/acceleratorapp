            ...
            <div class="fields">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('employment_type_id', \App\Services\PersonService::employeeTypeForDropdown(),null,['id'=>'employment_type_id',
...
{{--                    </div>--}}
                ...
                <div class="row mb-3 row-govt" style="display: none;">
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('federal_provincial_id', \App\Services\PersonService::provincesForDropdown(),null,['id'=>'federal_provincial_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('ministry_id', \App\Services\PersonService::ministryForDropdown(),null,['id'=>'ministry_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('govt_organization_id', \App\Services\PersonService::organizationsForDropdown(),null,['id'=>'govt_organization_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('govt_department_id', \App\Services\PersonService::departmentForDropdown(),null,['id'=>'govt_department_id',
                ...
                <div class="row mb-3 row-govt" style="display: none;">
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('govt_grade_id', \App\Services\PersonService::gradesForDropdown(),null,['id'=>'govt_grade_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('govt_profession_id', \App\Services\PersonService::professionsForDropdown(),null,['id'=>'govt_profession_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('govt_serving_retired',\App\Services\PersonService::serviceOrRetiredForDropdown(), null,['id'=>'govt_serving_retired',
                ...
                <div class="row mb-3 row-private" style="display: none;">
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('private_organization_id', \App\Services\PersonService::organizationsForDropdown(),null,['id'=>'private_organization_id',
                            'style' => 'width:100%;', 'class'=>'select2 form-control', 'placeholder'=>__('general.ph_organization')])
                        !!}
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('private_department_id', \App\Services\PersonService::departmentForDropdown(),null,['id'=>'private_department_id',
                            'style' => 'width:100%;', 'class'=>'select2 form-control', 'placeholder'=>__('general.ph_department')])
                        !!}
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('private_grade_id', \App\Services\PersonService::gradesForDropdown(),null,['id'=>'private_grade_id',
                            'style' => 'width:100%;', 'class'=>'select2 form-control', 'placeholder'=>__('general.ph_grade')])
                        !!}
                    </div>
                </div>
                <div class="row mb-3 row-private" style="display: none;">
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('private_profession_id', \App\Services\PersonService::professionsForDropdown(),null,['id'=>'private_profession_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('private_serving_retired',\App\Services\PersonService::serviceOrRetiredForDropdown(), null,['id'=>'private_serving_retired',
                            'style' => 'width:100%;', 'class'=>'select2 form-control','placeholder'=>__('general.ph_serving_retired')])
                        !!}
                    </div>
                ...
                <div class="row mb-3 row-own" style="display: none;">
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('owner_partner', \App\Services\PersonService::ownerOrPartnerForDropdown(),null,['id'=>'owner_partner',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('own_business_id', \App\Services\PersonService::businessTypesForDropdown(),null,['id'=>'own_business_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('own_business_sub_id', \App\Services\PersonService::businessSubTypesForDropdown(),null,['id'=>'own_business_sub_id',
                ...
                <div class="row mt-3 mb-3">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        {!!  Form::select('tax_type_id', \App\Services\PersonService::taxTypeForDropdown(),null,['id'=>'tax_type_id',
                    ...
                    <div class="col-md-3">
                        ...
                        {!!  Form::select('tax_status_id', \App\Services\PersonService::taxStatusForDropdown(),null,['id'=>'tax_status_id',
