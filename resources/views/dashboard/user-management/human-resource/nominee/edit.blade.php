            ...
            <div class="card shadow-none pt-0">
                ...
                <div class="card-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        @include('dashboard.user-management.human-resource.nominee.components.detail',['for'=>'edit'])
                        @include('dashboard.user-management.human-resource.nominee.components.record',['for'=>'edit','records'=>$verification])
                        @include('dashboard.user-management.human-resource.nominee.components.media',['for'=>'edit'])
                    </div>
