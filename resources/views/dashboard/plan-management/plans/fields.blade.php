<div class="row mb-3">
    ...
    <div class="col-md-3 mb-3">
        {!!  Html::decode(Form::label('no_of_persons' ,__('general.no_of_persons').'<i class="text-danger">*</i>' ,['class'=>'form-label']))   !!}
        {!!  Form::number('no_of_persons',1,['id'=>'no_of_persons', 'class'=>'form-control vertical-spin','required','readonly'])  !!}
    </div>
    <div class="col-md-3 mb-3">
