<div class="card">
    ...
    <div class="card-body collapse">
        {!! Form::open(['url' => route('dashboard.seller-ledger'), 'method' => 'GET','files' => true]) !!}
        <div class="row mb-2">
            <div class="col-md-4">
                {!!  Html::decode(Form::label('seller_id' ,__('general.seller_investor') ,['class'=>'form-label']))   !!}
                {!!  Form::select('seller_id', $sellers, request()->has('seller_id')?request()->get('seller_id'):null,['id'=>'seller_id',
                    'class'=>'select2 form-control', 'placeholder'=>__('general.ph_seller_investor'),'style'=>'width:100%'])
                !!}
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                ...
                <a href="{{ route('dashboard.seller-ledger') }}" class="btn btn-primary w-md">{{ __('general.clear') }} <i class="fa fa-times"></i></a>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
