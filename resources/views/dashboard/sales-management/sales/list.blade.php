@forelse($records as $record)
    <tr>
        ...
        <td>
            <span data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('general.building') }}: {{ \App\Services\BuildingService::getBuildingName() }}<br>{{ __('general.floor') }}: {{ $record->floor->name }}">
                {{ $record->flat->name }}
            </span>
        </td>
        <td>
