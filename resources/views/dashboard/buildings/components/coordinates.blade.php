...
<div class="collapse" id="collapseCoordinates">
    ...
    @include('dashboard.buildings.components.coordinates-d-row')
    @include('dashboard.buildings.components.coordinates-street-row')
    <h5 class="card-title">{{ __('general.coordinates') }}</h5>
    @include('dashboard.buildings.components.coordinates-x-row')
    @include('dashboard.buildings.components.coordinates-y-row')
</div>
{{--</div>--}}
