   ...
   <div class="col-md-8">
      <div class="row">
          ...
          <div class="col-md-4">
              ...
              {!!  Form::date('event_name',null,['id'=>'event_name','class'=>'form-control']) !!}
          </div>
          <div class="col-md-4">
              {!!  Html::decode(Form::label('event_start_date' ,__('general.event_start_date') ,['class'=>'form-label']))   !!}
              {!!  Form::date('event_start_date',null,['id'=>'event_start_date','class'=>'form-control datepicker']) !!}
          </div>
          <div class="col-md-4">
              {!!  Html::decode(Form::label('no_of_days' ,__('general.no_of_days') ,['class'=>'form-label']))   !!}
              {!!  Form::time('no_of_days',null,['id'=>'no_of_days','class'=>'form-control']) !!}
          </div>
          <div class="col-md-4">
              {!!  Html::decode(Form::label('event_end_date' ,__('general.event_end_date') ,['class'=>'form-label']))   !!}
              {!!  Form::time('event_end_date',null,['id'=>'event_end_date','class'=>'form-control datepicker']) !!}
          </div>
          <div class="col-md-4">
              {!!  Html::decode(Form::label('event_start_time' ,__('general.event_start_time') ,['class'=>'form-label']))   !!}
              {!!  Form::time('event_start_time',null,['id'=>'event_start_time','class'=>'form-control timepicker']) !!}
          </div>
          <div class="col-md-4">
              {!!  Html::decode(Form::label('event_end_time' ,__('general.event_end_time') ,['class'=>'form-label']))   !!}
              {!!  Form::time('event_end_time',null,['id'=>'event_end_time','class'=>'form-control timepicker']) !!}
          </div>
          <div class="col-md-4">
...
<div class="mb-3 row">
    <div class="col-12">
        ...
        {!!  Form::textarea('event_social_media_url',null,['id'=>'event_social_media_url','class'=>'form-control', 'rows'=>'2']) !!}
    </div>
</div>
