            ...
            <div class="card shadow-none pt-0">
                ...
                <div class="card-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        @include('dashboard.flat-management.flats.components.flat', ['for' => 'edit'])
{{--                        @include('dashboard.real-estate.flat.components.ownership', ['for' => 'edit', 'records' => $model->owners])--}}
                        @include('dashboard.flat-management.flats.components.area-amount', ['for' => 'edit'])
                    </div>
...
@endsection
@include('dashboard.flat-management.flats.components.scripts', ['for' => 'edit'])
