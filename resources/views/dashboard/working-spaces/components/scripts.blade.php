    ...
    <script>
        function show_floor_offices(cElement, id) {
            ...
            if (value === '') {
                ...
                let table = '<table class="table table-bordered mt-2"><thead><tr><th class="fs-13">{{__('general.name')}}</th><th class="fs-13">{{__('general.number')}}</th><th class="fs-13">{{ __('general.sitting_capacity') }}</th></thead><tbody>';
