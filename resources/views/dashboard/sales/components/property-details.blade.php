...
<div class="row mb-2">
{{--                    <div class="col-md-3">
        {!!  Html::decode(Form::label('building_id' ,__('general.building').'<i class="text-danger">*</i>' ,['class'=>'form-label']))   !!}
        {!!  Form::select('building_id', \App\Services\RealEstate\BuildingService::getBuildingsOfBusiness(),null,['id'=>'building_id',
            'class'=>'select2 form-control', 'placeholder'=>__('general.ph_building_name'),'required','style'=>'width:100%',
            'onchange' => 'getFloorsOfBuilding(this);'])
        !!}
        @error('building_id')
