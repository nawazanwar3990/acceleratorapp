    ...
    <div class="col-md-6">
        ...
        <div class="row mb-2">
            <div class="col-md-8">
                ...
                <select name="flat_id" class="form-control flats" id="flat_id" required onchange="getInstallmentInvoiceOfFlat();">
        ...
        <div class="row mb-2 amount-row" style="display: none;">
            <div class="col-md-8">
                ...
                {!!  Form::select('sales', [], null,['id'=>'sales', 'required',
                    'class'=>'select2 form-control', 'placeholder'=>__('general.ph_sales_invoice'),'style'=>'width:100%', 'disabled', 'tabindex'=>'-1'])
                !!}
                {!!  Form::hidden('sale_id',null ,['id'=>'sale_id']) !!}
            </div>
        </div>
        <div class="row mb-2 amount-row"  style="display: none;">
            <div class="col-md-8">
                {!!  Html::decode(Form::label('installments' ,__('general.installment').'<i class="text-danger">*</i>' ,['class'=>'form-label']))   !!}
                {!!  Form::select('installments', [], null,['id'=>'installments', 'required', 'onchange' => 'getInstallmentDetails();',
                    'disabled', 'class'=>'select2 form-control', 'style'=>'width:100%'])
                !!}
                {!!  Form::hidden('installment_id',null ,['id'=>'installment_id']) !!}
            </div>
        </div>
        <div class="row mb-2 amount-row" style="display: none;">
            <div class="col-md-8">
        ...
        <div class="row mb-2 penalty-row" style="display: none;">
            <div class="col-md-8">
                {!!  Html::decode(Form::label('penalty_amount' ,__('general.penalty_amount').'<i class="text-danger">*</i>' ,['class'=>'form-label']))  !!}
                {!!  Form::text('penalty_amount',null ,['id'=>'penalty_amount','class'=>'form-control', 'readonly', 'tabindex'=>'-1']) !!}
            </div>
        </div>
        <div class="row mb-2 penalty-row" style="display: none;">
            <div class="col-md-8">
                {!!  Html::decode(Form::label('penalty_waived_off' ,__('general.penalty_waived_off_percent').'<i class="text-danger">*</i>' ,['class'=>'form-label']))  !!}
                {!!  Form::number('penalty_waived_off',null ,['step'=>'any','min'=>0,'max'=>100,'id'=>'penalty_waived_off','class'=>'form-control', 'calculatePenalty();']) !!}
                {!!  Form::hidden('penalty_waived_off_amount',null ,['id'=>'penalty_waived_off_amount']) !!}
            </div>
        </div>
        <div class="row mb-2 amount-row" style="display: none;">
            <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="row mb-2">
                    ...
                    <div class="col-md-7 text-right">
                        ...
                        <a id="installment-btn" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target=".installment-modal" class="btn btn-primary btn-sm">{{ __('general.view_installments') }}</a>
                    </div>
                    <hr class="mb-2 mt-1">
                </div>
                ...
                <table class="table  table-sm" id="details">
                    ...
                    <tr>
                        <td class="bg-light card-title col-3">{{ __('general.installment_amount') }}</td>
                        <td class="col-5" id="col-installment-amount">0.00</td>
                    </tr>
                    </tbody>
                </table>
            </div>
