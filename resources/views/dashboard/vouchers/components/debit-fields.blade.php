<div class="row mb-2">
    <div class="col-md-3">
        ...
        {!!  Form::text('voucher_no', \App\Services\Accounts\VoucherService::getNextVoucherNo('DV') ,['id'=>'voucher_no','class'=>'form-control', 'readonly', 'tabindex'=>'-1']) !!}
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        {!!  Html::decode(Form::label('payment_account' ,__('general.credit_account_name').'<i class="text-danger">*</i>' ,['class'=>'form-label']))   !!}
...
<div class="row">
    <div class="col-md-12">
        <table class="table table-bordered" style="width: 100%;">
            <thead>
                <tr>
                    <th class="text-center">{{ __('general.debit_account_name') }}<i class="text-danger"> *</i></th>
            ...
            <tbody>
                <tr>
                    <td>
                        {!!  Form::select('debitAccount[]',$accountHeads,null,['class'=>'select2 form-control',
