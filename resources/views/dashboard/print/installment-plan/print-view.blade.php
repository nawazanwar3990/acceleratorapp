                ...
                <div class="card-body border-top">
                    ...
                    <section id="printHolder">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-3">
                                @include('dashboard.print.installment-plan.component.first-penalty')
                                @include('dashboard.print.installment-plan.component.second-penalty')
                                @include('dashboard.print.installment-plan.component.third-penalty')
                            </div>
