                ...
                <div class="card-body border-top">
                    <section id="printHolder" style="padding: 0px">
                        ...
                        <div class="print-view-page">
                            @include('dashboard.print.title-transfer.component.top-header')
                            @include('dashboard.print.title-transfer.component.property-detail')
                            @include('dashboard.print.title-transfer.component.seller-detail')
                            @include('dashboard.print.title-transfer.component.purchase-detail')
                            @include('dashboard.print.title-transfer.component.payment-method')
