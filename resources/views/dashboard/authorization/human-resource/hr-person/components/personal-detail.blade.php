    ...
    <div class="fields">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                ...
                {!!  Form::select('cast_id', \App\Services\PersonService::castsForDropdown(),null,['id'=>'cast_id',
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                {!!  Form::select('nationality_id', \App\Services\PersonService::nationalitiesForDropdown(),isset($for) ? $model->nationality_id : 1,['id'=>'nationality_id',
            ...
            <div class="col-md-3">
                ...
                {!!  Form::select('country_stay_in', \App\Services\PersonService::countriesForDropdown(),null,['id'=>'country_stay_in',
