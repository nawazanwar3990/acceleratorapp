            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <section id="printArea">
                        ...
                        @endif
                        @include('dashboard.authorization.human-resource.hr-person.print-components.header')
                        ...
                        @include('dashboard.authorization.human-resource.hr-person.print-components.finger-print')
                        @include('dashboard.authorization.human-resource.hr-person.print-components.declaration')
