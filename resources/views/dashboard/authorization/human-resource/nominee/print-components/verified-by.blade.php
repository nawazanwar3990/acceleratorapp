    ...
    <div class="card-header  py-1">
        <div class="input-group font-weight-bold">
            <div class="input-group">
                <div><h5><b>Verified By</b></h5></div>
            </div>
        </div>
    </div>
    <div class="card-body py-2">
        @foreach($verification as $verified)
            <div class="row py-2">
                <div class="col-1 text-center align-self-center">
                    <img src="{{ isset($verified->hr->mediaFirstImage->filename)?asset($verified->hr->mediaFirstImage->filename):asset('theme/images/user-picture.png') }}"
