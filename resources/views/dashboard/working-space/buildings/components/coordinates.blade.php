...
<div class="collapse" id="collapseCoordinates">
    ...
    @include('dashboard.working-space.buildings.components.coordinates-d-row')
    @include('dashboard.working-space.buildings.components.coordinates-street-row')
    <h5 class="card-title">{{ __('general.coordinates') }}</h5>
    @include('dashboard.working-space.buildings.components.coordinates-x-row')
    @include('dashboard.working-space.buildings.components.coordinates-y-row')
</div>
