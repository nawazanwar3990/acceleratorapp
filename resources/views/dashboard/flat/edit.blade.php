            ...
            <div class="card shadow-none pt-0">
                ...
                <div class="card-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        @include('dashboard.flat.components.flat', ['for' => 'edit'])
{{--                        @include('dashboard.real-estate.flat.components.ownership', ['for' => 'edit', 'records' => $model->owners])--}}
                        @include('dashboard.flat.components.area-amount', ['for' => 'edit'])
                    </div>
...
@endsection
@include('dashboard.flat.components.scripts', ['for' => 'edit'])
