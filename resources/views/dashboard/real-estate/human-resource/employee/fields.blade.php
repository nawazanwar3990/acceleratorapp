    ...
    <div class="form-body">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                {!!  Form::select('department_id', \App\Services\RealEstate\HrService::departmentForDropdown(),null,['id'=>'department_id',
            ...
            <div class="col-md-4">
                ...
                {!!  Form::select('designation_id', \App\Services\RealEstate\HrService::designationForDropdown(),null,['id'=>'designation_id',
