<div class="my-3">
{{--    <h2 class="accordion-header" id="contact_heading">--}}
...
{{--    <div id="contact" class="accordion-collapse collapse bg-white" aria-labelledby="contact_heading"--}}
            ...
            <div class="fields">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        {!!  Form::select('sec_contact_relation', \App\Services\RealEstate\HrService::relationsForDropdown(),null,['id'=>'contact_relation',
