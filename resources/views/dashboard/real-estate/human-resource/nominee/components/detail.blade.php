                    ...
                    <div class="col-md-12">
                        @include('dashboard.real-estate.common.single-hr-picker',
                            [
                                ...
                                'for' => 'edit',
                                'records'=>\App\Services\RealEstate\HrService::getHrById($model->owner_hr_id ?? null)
                            ])
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        @include('dashboard.real-estate.common.single-hr-picker',
                            [
                                ...
                                'for' => 'edit',
                                'records'=>\App\Services\RealEstate\HrService::getHrById($model->nominee_hr_id ?? null)
                            ])
                    </div>
                </div>
            </div>
