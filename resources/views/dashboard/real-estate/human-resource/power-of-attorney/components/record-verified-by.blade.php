        ...
        <div class="accordion-body">
            <div class="fields">
                ...
                <div class="row mb-3">
                    ...
                    <hr>
                    @include('dashboard.real-estate.common.hr-picker', ['fieldName' => 'verified_hr_id','for'=>'edit','records'=>$verification])
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <hr>
                    @include('dashboard.real-estate.common.hr-picker', ['fieldName' => 'witness_hr_id','for'=>'edit','records'=>$witness])
                </div>
            </div>
        </div>
    </div>
