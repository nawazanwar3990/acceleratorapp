                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-12">
                        ...
                        [
                            ...
                            'for' => 'edit',
                            'records'=>\App\Services\RealEstate\HrService::getHrById($model->executant_hr_id ?? null)])
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        [
                            ...
                            'for' => 'edit',
                            'records'=>\App\Services\RealEstate\HrService::getHrById($model->auth_attorney_hr_id ?? null)])
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4">
                        {!! Form::label('relation_type_id',__('general.relation_with_executant')) !!}
                        {!! Form::select('relation_type_id',\App\Services\RealEstate\HrService::relationsForDropdown(),null,['class'=>'form-control select2','id'=>'poa_relation_type_id','placeholder'=>'Select Relation','style'=>'width:100%']) !!}
                    </div>
                </div>
            </div>
        </div>
