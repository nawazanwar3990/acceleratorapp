...
@section('content')
    <div class="row">
        <div class="col-12">
            @include('dashboard.real-estate.quotation.filters')
            <div class="card shadow-none pt-0">
                @include('components.General.form-list-header',['url'=>'dashboard.quotations.create','is_create'=>true])
                <div class="card-body">
                    <table class="table table-bordered table-hover" id="datatable">
                        @include('components.General.table-headings',['headings'=>\App\Enum\TableHeadings\RealEstate\Quotation::getTranslationKeys()])
                        <tbody>
                        @include('dashboard.real-estate.quotation.list')
                        </tbody>
                    </table>
                </div>
            </div>
