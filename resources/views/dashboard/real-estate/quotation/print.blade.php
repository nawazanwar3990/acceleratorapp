            ...
            <div class="card">
                ...
                <div class="card-body border-top">
                    <section id="printArea" style="padding: 0px">
                        ...
                        @include('dashboard.real-estate.quotation.components.print.general')
                        @include('dashboard.real-estate.quotation.components.print.property-details')
                        @include('dashboard.real-estate.quotation.components.print.payment-details')
                        @include('dashboard.real-estate.quotation.components.print.installment-details')
