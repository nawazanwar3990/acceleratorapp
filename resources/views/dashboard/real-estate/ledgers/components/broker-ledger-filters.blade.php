<div class="card">
    ...
    <div class="card-body collapse">
        {!! Form::open(['url' => route('dashboard.broker-ledger'), 'method' => 'GET','files' => true]) !!}
        <div class="row mb-2">
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                ...
                <a href="{{ route('dashboard.broker-ledger') }}" class="btn btn-primary w-md">{{ __('general.clear') }} <i class="fa fa-times"></i></a>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
