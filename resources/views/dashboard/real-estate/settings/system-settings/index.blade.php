...
@section('content')
    <div class="container">
        ...
        <x-created-by-field />
        @include('dashboard.real-estate.settings.system-settings.components.settings-fields',['records'=>$records])
        <div class="row">
    ...
    @include('dashboard.real-estate.settings.system-settings.print-view.view-page')
@endsection
@section('innerScript')
