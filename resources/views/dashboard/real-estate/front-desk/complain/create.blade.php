        ...
        <div class="col-12">
            <div class="card card-shadow pt-0">
                ...
                <div class="card-body" style="padding-top: 0;">
                    {!! Form::open(['url' => route('dashboard.complain.store'), 'method' => 'POST','files' => true,'id' =>'complain_form', 'class' => 'solid-validation']) !!}
                    <x-created-by-field/>
                    <x-hidden-building-id/>
                    @include('dashboard.real-estate.front-desk.complain.fields')
                    <x-buttons :save="true" :saveNew="true" :cancel="true" :reset="true"
                               formID="complain_form" cancelRoute="dashboard.complain.index"/>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
