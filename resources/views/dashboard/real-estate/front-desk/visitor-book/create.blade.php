        ...
        <div class="col-12">
            <div class="card card-shadow pt-0">
                ...
                <div class="card-body" style="padding-top: 0;">
                    {!! Form::open(['url' => route('dashboard.visitor-book.store'), 'method' => 'POST','files' => true,'id' =>'visitor_book_form', 'class' => 'solid-validation']) !!}
                        <x-created-by-field />
                    <x-hidden-building-id />
                        @include('dashboard.real-estate.front-desk.visitor-book.fields')
                        <x-buttons :save="true" :saveNew="true" :cancel="true" :reset="true"
                                   formID="visitor_book_form" cancelRoute="dashboard.visitor-book.index"/>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
