        ...
        <div class="col-12">
            <div class="card card-shadow pt-0">
                ...
                <div class="card-body" style="padding-top: 0;">
                    {!! Form::open(['url' => route('dashboard.postal-dispatch.store'), 'method' => 'POST','files' => true,'id' =>'postal_dispatch_form', 'class' => 'solid-validation']) !!}
                    <x-created-by-field/>
                    <x-hidden-building-id/>
                    @include('dashboard.real-estate.front-desk.postal-dispatch.fields')
                    <x-buttons :save="true" :saveNew="true" :cancel="true" :reset="true"
                               formID="postal_dispatch_form" cancelRoute="dashboard.postal-dispatch.index"/>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
