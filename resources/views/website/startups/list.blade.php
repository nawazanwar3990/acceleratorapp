{{--<div class="card px-5 py-3  rounded-3">--}}
{{--        <div>--}}
...
<div class="card mt-3 shadow rounded-3" style="5px 5px 5px 5px rgb(210 209 209 / 75%)">
    <div class="card-body">
        ...
        <div class="col-md-12">
            <h3 class="text-center fw-bold text-uppercase">Optimum Tech</h3>
            <p class="text-center pt-2">We develop and implement a systemic approach to outsmart your competition and employ a multifaceted strategy.</p>
            <div class="text-center">
                <button class="read-more btn px-3 py-2 mt-3 rounded-2">View Services</button>
            </div>
        </div>
    </div>
