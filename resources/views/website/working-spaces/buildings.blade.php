                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Search Result For
                                            ...
                                            "</h4>
                                        <h6 class="card-subtitle">About {{ count($buildings) }} result ( 0.10
                                            seconds)</h6>
                                        @foreach($buildings as $building)
                                            <div class="d-flex flex-row comment-row">
                                                ...
                                                <div class="comment-text w-100 align-self-center">
                                                    <h3><a href="javacript:void(0)">{{ $building->name }}</a></h3>
                                                    <div class="comment-footer">
                                                        <span class="date">{{ $building->created_at }}</span>
                                                    ...
                                                    <table class="table stylish-table table-sm m-b-5 m-t-10">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>{{ trans('general.entry_gates') }}</th>
                                                            <th>{{ trans('general.no_of_floors') }}</th>
                                                            <th>{{ trans('general.facing') }}</th>
                                                            <th>{{ trans('general.action') }}</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
                                                            <td>{{ $building->area }} {{ trans('general.sqft') }}</td>
                                                            <td>{{ $building->entry_gates }}</td>
