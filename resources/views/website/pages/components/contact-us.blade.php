<section class="contact-us-holder py-5">
    <div class="container">
        <div class="row">
            <div>
                ...
                <div class="mt-5">
                    ...
                    <div class="row  mt-4">
                        ...
                        <div class="col-md-10 align-self-center">
                            ...
                            <p>SundayTo Thursday From 9 AM To 5 PM</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form class="">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label">Email <sup>*</sup></label>
                                <input type="email" id="email" class="form-control" placeholder="Enter Your Email">
                            </div>
                            <div class="mb-3">
                                <label for="subject" class="form-label">Subject <sup>*</sup></label>
                                <input type="text" id="subject" class="form-control contact_form" placeholder="Subject">
                            </div>
                            <div class="mb-3">
                                <label for="msg" class="form-label">Message <sup>*</sup></label>
                                <textarea id="msg" class="contact_form form-control"></textarea>
                            </div>
