<div class="section section-feature-grey is-medium">
    <div class="container">
        ...
        <div class="has-text-centered mt-40 mb-40 is-title-reveal" data-sr-id="1"
            ...
            <div class="modern-team">
                ...
                <article class="modern-team-item circle-mask zoom-effect">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/img/demo/agency/team/one.jpg" class="member-avatar" alt=""
                                 data-demo-src="assets/img/demo/agency/team/one.jpg">
                        </div>
                ...
                <article class="modern-team-item circle-mask rotate-zoom-effect">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/img/demo/agency/team/two.jpg" class="member-avatar" alt=""
                                 data-demo-src="assets/img/demo/agency/team/two.jpg">
                        </div>
                        <div class="overlay-wrapper">
                            <div>
                                <a href="#0" class="social">
                ...
                <article class="modern-team-item circle-mask zoom-slide-effect">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/img/demo/agency/team/three.jpg" class="member-avatar" alt=""
                                 data-demo-src="assets/img/demo/agency/team/three.jpg">
                        </div>
                        <div class="overlay-wrapper">
                            <div>
                                <a href="#0" class="social">
...
<div class="section is-medium">
    <div class="container">
        ...
        <div class="centered-title">
            ...
            <div class="title-divider"></div>
            <div class="subheading">
                Discover the meaning of digital quality and hire our team. Let's work
                together.
            </div>
        </div>
        <!-- /Title -->
        ...
        <div class="content-wrapper">
            ...
            <div class="pt-60 pb-60 has-text-centered">
                ...
                is-title-reveal
              " data-sr-id="2"
                   style="; visibility: visible;  -webkit-transform: translateY(0) scale(1); opacity: 1;transform: translateY(0) scale(1); opacity: 1;-webkit-transition: all 0.5s ease 0s, -webkit-transform 0.6s cubic-bezier(0.215, 0.61, 0.355, 1) 0.1s, opacity 0.6s cubic-bezier(0.215, 0.61, 0.355, 1) 0.1s; transition: all 0.5s ease 0s, transform 0.6s cubic-bezier(0.215, 0.61, 0.355, 1) 0.1s, opacity 0.6s cubic-bezier(0.215, 0.61, 0.355, 1) 0.1s; ">Start
                    a project</a>
            </div>
        </div>
    </div>
