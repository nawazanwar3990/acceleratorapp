...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        {!!  Form::date('sp_date_of_initiation',isset($model)?\Carbon\Carbon::parse($model->sp_date_of_initiation)->format('Y-m-d'):null,['id'=>'company_date_of_initiation','class'=>'form-control','required']) !!}
    </div>
    <div class="col-md-6 mb-3">
