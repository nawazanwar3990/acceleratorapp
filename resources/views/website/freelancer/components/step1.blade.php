<div class="row">
    ...
    <div class="col-md-6 mb-3">
        {!!  Html::decode(Form::label('is_register_sp' ,__('general.is_register_company'),['class'=>'col-form-label']))   !!}
        {!!  Form::select('is_register_sp',\App\Services\GeneralService::yesOrNoForDropdown(),isset($model)?$model->is_register_company:null,['id'=>'is_register_company','class'=>'form-control','required','placeholder'=>trans('general.select')]) !!}
    </div>
</div>
<div class="row @if(isset($model) AND $model->is_register_sp=='yes') d-block @else d-none @endif"
    ...
    <div class="col-12 mb-3">
        <table class="table table-bordered table-hover table-sm">
            ...
            <tbody>
            @if(isset($model) AND $model->is_register_sp=='yes' AND is_array($model->sp_institutes) AND count($model->sp_institutes)>0)
                @foreach($model->sp_institutes as $company_institute)
                    <tr>
                        <td>
                            {!!  Form::text('sp_institutes[]',$company_institute,['id'=>'sp_institutes[]','class'=>'form-control form-control-sm','autocomplete'=>'off']) !!}
                        </td>
...
<div class="row">
    <div class="col-md-6 mb-3">
        {!!  Html::decode(Form::label('sp_no_of_emp' ,__('general.company_no_of_emp').'<i class="text-danger">*</i>',['class'=>'col-form-label']))   !!}
    ...
    <div class="col-md-6 mb-3">
        ...
        {!!  Form::string('sp_date_of_initiation',isset($model)?\Carbon\Carbon::parse($model->sp_date_of_initiation)->format('Y-m-d'):null,['id'=>'company_date_of_initiation','class'=>'form-control datepicker','required']) !!}
    </div>
    <div class="col-md-6 mb-3">
    ...
    <div class="col-md-6 mb-3">
        {!!  Html::decode(Form::label('sp_email' ,__('general.company_email').'<i class="text-danger">*</i>',['class'=>'col-form-label']))   !!}
        {!!  Form::email('sp_email',isset($model)?$model->sp_email:null,['id'=>'sp_email','class'=>'form-control','required']) !!}
    </div>
    <div class="col-12 mb-3">
        {!!  Html::decode(Form::label('sp_address' ,__('general.company_address').'<i class="text-danger">*</i>',['class'=>'col-form-label']))   !!}
