<div class="row">
    ...
    <div class="col-12 mb-3">
        ...
        {!!  Form::email('email',isset($model)?$model->user->email:null,['id'=>'email','class'=>'form-control','required','placeholder'=>'abc@gmail.com']) !!}
        @error('email')
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        {!!  Form::text('first_name',isset($model)?$model->user->first_name:null,['id'=>'first_name','class'=>'form-control']) !!}
    </div>
    <div class="col-md-6 mb-3">
        {!!  Html::decode(Form::label('last_name' ,__('general.last_name'),['class'=>'form-label']))   !!}
        {!!  Form::text('last_name',isset($model)?$model->user->last_name:null,['id'=>'first_name','class'=>'form-control']) !!}
    </div>
</div>
<div class="row">
    <div class="col-md-6 mb-3">
    ...
    <div class="col-md-6 mb-3">
        ...
        {!!  Form::select('security_question_name',\App\Enum\SecurityQuestionEnum::getTranslationKeys(),isset($model)?$model->user->security_question_name:null,['id'=>'security_question_name','class'=>'form-control','placeholder'=>__('general.select'), 'required']) !!}
    </div>
    <div class="col-md-6 mb-3">
        {!!  Html::decode(Form::label('security_question_value' ,__('general.security_question_value'),['class'=>'col-form-label']))   !!}
        {!!  Form::text('security_question_value',isset($model)?$model->user->security_question_value:null,['id'=>'security_question_value','class'=>'form-control','required']) !!}
    </div>
    <div class="col-12 mb-3">
        {!!  Html::decode(Form::label('know_about_us' ,__('general.know_about_us').'<i class="text-danger">*</i>' ,['class'=>'form-label']))   !!}
        {!!  Form::select('know_about_us',\App\Enum\KnowAboutUsEnum::getTranslationKeys(),isset($model)?$model->user->know_about_us:null,['id'=>'know_about_us','class'=>'form-control','placeholder'=>__('general.select'), 'required']) !!}
    </div>
</div>
