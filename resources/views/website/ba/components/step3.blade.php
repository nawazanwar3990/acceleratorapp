        ...
        <div class="row">
            ...
            @if($model->type ==\App\Enum\AcceleratorTypeEnum::INDIVIDUAL)
                ...
                <div class="col-md-6 mb-3">
                    ...
                    {!!  Form::select('ba_already_emp',['yes'=>'Yes','no'=>'No'],$model->ba_already_emp??null,['id'=>'ba_already_emp','class'=>'form-control','placeholder'=>'select','onchange'=>'already_employee();']) !!}
                </div>
            @endif
        </div>
        @if($model->type ==\App\Enum\AcceleratorTypeEnum::INDIVIDUAL)
                ...
                <div class="col-12 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                @foreach(\App\Enum\EmployeeTypeEnum::getTranslationKeys() as $emp_key=>$emp_value)
                                    <div class="form-check form-switch form-check-inline">
                                        {!! Form::radio('ba_emp_type',$emp_value,false,['id'=>$emp_key,'class'=>'form-check-input']) !!}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-3">
                                    {!!  Html::decode(Form::label('ba_emp_location' ,__('general.employee_location'),['class'=>'form-label']))   !!}
                                    {!!  Form::text('ba_emp_location',$model->ba_emp_location??null,['id'=>'ba_emp_location','class'=>'form-control']) !!}
                                </div>
                                <div class="col-md-6 mb-3">
                                    {!!  Html::decode(Form::label('ba_emp_timing' ,__('general.employee_timing'),['class'=>'form-label']))   !!}
                                    {!!  Form::text('ba_emp_timing',$model->ba_emp_timing??null,['id'=>'ba_emp_timing','class'=>'form-control']) !!}
                                </div>
                                <div class="col-md-6 mb-3">
                                    {!!  Html::decode(Form::label('ba_emp_designation' ,__('general.employee_designation'),['class'=>'form-label']))   !!}
                                    {!!  Form::text('ba_emp_designation',$model->ba_emp_designation??null,['id'=>'ba_emp_designation','class'=>'form-control']) !!}
                                </div>
                                <div class="col-md-6 mb-3">
                                    {!!  Html::decode(Form::label('ba_emp_description' ,__('general.employee_description'),['class'=>'form-label']))   !!}
                                    {!!  Form::text('ba_emp_description',$model->ba_emp_description??null,['id'=>'ba_emp_description','class'=>'form-control']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
