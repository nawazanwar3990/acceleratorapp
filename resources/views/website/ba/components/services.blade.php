@php
    $service_type= ($type=='company')?\App\Enum\ServiceTypeEnum::BUSINESS_ACCELERATOR:\App\Enum\ServiceTypeEnum::BUSINESS_ACCELERATOR_INDIVIDUAL;
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text p-2">
                                            <div class="form-check form-switch">
                                                {!! Form::checkbox('unlimited','∞',(isset($search_value[0]) && $search_value[0]['pivot']['building_limit']==='∞'),['class'=>'form-check-input','onclick'=>'change_limit_switcher(this);']) !!}
                            ...
                            <div class="col-6 align-self-center">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text p-2">
                                            <div class="form-check form-switch">
                                                {!! Form::checkbox('unlimited','∞',(isset($search_value[0]) && $search_value[0]['pivot']['floor_limit']==='∞'),['class'=>'form-check-input','onclick'=>'change_limit_switcher(this);']) !!}
                                                {!! Form::label('unlimited',trans('general.unlimited'),['class'=>'form-check-label']) !!}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6 align-self-center">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text p-2">
                                            <div class="form-check form-switch">
                                                {!! Form::checkbox('unlimited','∞',(isset($search_value[0]) && $search_value[0]['pivot']['office_limit']==='∞'),['class'=>'form-check-input','onclick'=>'change_limit_switcher(this);']) !!}
                                                {!! Form::label('unlimited',trans('general.unlimited'),['class'=>'form-check-label']) !!}
                                            </div>
                                        </div>
                                    </div>
