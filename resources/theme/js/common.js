    ...
    Swal.fire({
        ...
        switch (regType) {
            case 'business_accelerator':
                ...
                break;
            case 'customer':
                location.assign('/customers/create/user-info');
                break;
            case 'mentor':
...
function apply_payment(parent = null, type) {
    ...
    Swal.fire({
        ...
        setCookie('is_register', 'yes');
        setCookie('register_detail', JSON.stringify({
            'parent': parent,
            'type': type,
        ...
        if (parent === 'ba' || parent === 'freelancers') {
            ...
            route = '/' + parent + '/create/' + payment_type + "/user-info";
        }
        setCookie('register_route', route);
        apply_login_types();
        //location.assign(route);
    });
}

function apply_login_types() {
    let html = '<div class="row justify-content-center"><div class="col-sm-6 col-xs-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3"> <div class="card border position-relative"><div class="radio-holder position-absolute" style="right:0;top:9px;"> <div class="form-check form-switch"><input class="form-check-input" name="login_type" type="radio" id="facebook" value="facebook"> <label class="form-check-label" for="facebook"></label> </div></div><img class="card-img-top p-5 pb-0" src="/images/icon/social_facebook.png" alt="Facebook"><div class="card-body" style="height: 73px;"><h6 class="card-title">Facebook</h6> </div></div></div><div class="col-sm-6 col-xs-6 col-md-3 col-lg-3 col-xl-3 copl-xxl-3"> <div class="card border position-relative"><div class="radio-holder position-absolute" style="right:0;top:9px;"> <div class="form-check form-switch"><input class="form-check-input" name="login_type" type="radio" id="google" value="google"> <label class="form-check-label" for="google"></label> </div></div><img class="card-img-top p-5 pb-0" src="/images/icon/social_google.png" alt="Google"><div class="card-body" style="height: 73px;"><h6 class="card-title">Google</h6> </div></div></div><div class="col-sm-6 col-xs-6 col-md-3 col-lg-3 col-xl-3 copl-xxl-3"> <div class="card border position-relative"><div class="radio-holder position-absolute" style="right:0;top:9px;"> <div class="form-check form-switch"><input class="form-check-input" name="login_type" type="radio" id="twitter" value="twitter"> <label class="form-check-label" for="twitter"></label> </div></div><img class="card-img-top p-5 pb-0" src="/images/icon/social_twitter.png" alt="Twitter"><div class="card-body" style="height: 73px;"><h6 class="card-title">Twitter</h6> </div></div></div><div class="col-sm-6 col-xs-6 col-md-3 col-lg-3 col-xl-3 copl-xxl-3"> <div class="card border position-relative"><div class="radio-holder position-absolute" style="right:0;top:9px;"> <div class="form-check form-switch"><input class="form-check-input" name="login_type" type="radio" id="ba" value="ba" checked="checked"> <label class="form-check-label" for="ba"></label> </div></div><img class="card-img-top p-5 pb-0" src="/images/icon/social_accelerator.png" alt="Business Accelerator"><div class="card-body" style="height: 73px;"><h6 class="card-title">Business Accelerator</h6> </div></div></div></div>';
    Swal.fire({
        title: 'Register via Social Media or Direct From Business Accelerator',
        html: html,
        confirmButtonText: 'Next',
        focusConfirm: false,
        width: 900,
        ...
        cancelButtonColor: '#01023B',
        preConfirm: () => {
            const login_type = Swal.getPopup().querySelector("input[name=login_type]:checked").value;
            return {
                login_type: login_type
            }
        }
    }).then((result) => {
        let login_type = result.value.login_type;
        if (login_type === 'ba') {
            location.assign(getCookie('register_route'));
        } else {
            let url = "http://accelator.businessholics.com/auth/login/" + login_type;
            location.assign(url);
        }
    });
}
