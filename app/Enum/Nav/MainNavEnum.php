...
class MainNavEnum extends AbstractEnum
{
    ...
    public const MENTOR_SECTION = KeyWordEnum::MENTOR_SECTION;
    ...
    public const MEETING_SCHEDULING = KeyWordEnum::MEETING_SCHEDULING;
    ...
    public static function getIcon($key = null): ?string
    {
        $routes = [
            ...
            self::MENTOR_SECTION => '<i class="fas fa-money-bill"></i>',
            ...
            self::MEETING_SCHEDULING => '<i class="fas fa-chart-bar"></i>',
    ...
    public static function getTranslationKeys(): array
    {
        return [
            ...
            self::MENTOR_SECTION => __(sprintf('%s.%s', 'general', self::MENTOR_SECTION)),
            ...
            self::MEETING_SCHEDULING => __(sprintf('%s.%s', 'general', self::MEETING_SCHEDULING)),
