...
class MainNavEnum extends AbstractEnum
{
    ...
    public static function getIcon($key = null): ?string
    {
        $routes = [
            ...
            self::PACKAGE_MANAGEMENT => '<i class="bx bx-package"></i>',
            self::SERVICE_MANAGEMENT => '<i class="bx bxs-customize"></i>',
            self::BUSINESS_ACCELERATOR => '<i class="bx bx-user-circle"></i>',
            self::CUSTOMER_MANAGEMENT => '<i class="bx bxs-user"></i>',
