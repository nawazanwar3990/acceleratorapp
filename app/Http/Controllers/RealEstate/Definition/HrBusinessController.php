...
use App\Http\Requests\RealEstate\Definition\HrBusinessRequest;
...
class HrBusinessController extends Controller
{
    ...
    public function index()
    {
        ...
        $records = HrBusiness::whereBuildingId(BuildingService::getBuildingId())->orderBy('name','ASC')->get();
        $params = [
    ...
    public function create()
    {
        ...
        $parentHeads = HrBusiness::whereBuildingId(BuildingService::getBuildingId())->whereParentId('0')
    ...
    public function edit($id)
    {
        ...
        $parentHeads = HrBusiness::whereBuildingId(BuildingService::getBuildingId())->whereParentId('0')
            ->orderBy('name', 'ASC')->pluck('name', 'id');
        $model = HrBusiness::whereBuildingId(BuildingService::getBuildingId())->findorFail($id);
