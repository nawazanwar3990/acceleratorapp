...
class GeneralController extends Controller
{
    ...
    public function salesInvoicesByFlat(Request $request) {
        ...
        if ($request->ajax()) {
            ...
            $records = Sale::whereBuildingId(BuildingService::getBuildingId())->where('flat_id', $flatID)
    ...
    public function getInstallmentDetails(Request $request) {
        ...
        if ($request->ajax()) {
            ...
            $record = Installment::whereBuildingId(BuildingService::getBuildingId())->findorFail($installmentID);
            $data = [
