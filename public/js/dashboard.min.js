...
!function (t, e) {
    ...
    var e = "SweetAlert2:", i = function (e) {
            ...
            var n;
            n = '"'.concat(t, '" is deprecated and will be removed in the next major release. Please use "').concat(e, '" instead.'), -1 === f.indexOf(n) && (f.push(n), C(n))
        }, h = function (t) {
        ...
        g = m(["success", "warning", "info", "question", "error"]), v = {previousBodyPadding: null},
        b = function (t, e) {
            return t.classList.contains(e)
        }, y = function (e, t, n) {
            p(e.classList).forEach(function (t) {
                -1 === i(x).indexOf(t) && -1 === i(g).indexOf(t) && e.classList.remove(t)
            }), t && t[n] && E(e, t[n])
        };
    ...
    var A, P = function (t) {
            ...
            var t = p(D().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function (t, e) {
                    return t = parseInt(t.getAttribute("tabindex")), (e = parseInt(e.getAttribute("tabindex"))) < t ? 1 : t < e ? -1 : 0
                }),
                e = p(D().querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], audio[controls], video[controls]')).filter(function (t) {
        ...
        it = function (t) {
            Ut.isVisible() && A !== t.target.value && Ut.resetValidationMessage(), A = t.target.value
        }, rt = function (t) {
            var e;
            if ((e = I()) && (e.parentNode.removeChild(e), O([document.documentElement, document.body], [x["no-backdrop"], x["toast-shown"], x["has-column"]])), nt()) k("SweetAlert2 requires document to initialize"); else {
                var n = document.createElement("div");
                n.className = x.container, n.innerHTML = ot;
                var o, i, r, a, s, c, u, l, d, p, f, m,
                    g = "string" == typeof (o = t.target) ? document.querySelector(o) : o;
                g.appendChild(n), i = t, (r = D()).setAttribute("role", i.toast ? "alert" : "dialog"), r.setAttribute("aria-live", i.toast ? "polite" : "assertive"), i.toast || r.setAttribute("aria-modal", "true"), a = g, "rtl" === window.getComputedStyle(a).direction && E(I(), x.rtl), s = z(), c = T(s, x.input), u = T(s, x.file), l = s.querySelector(".".concat(x.range, " input")), d = s.querySelector(".".concat(x.range, " output")), p = T(s, x.select), f = s.querySelector(".".concat(x.checkbox, " input")), m = T(s, x.textarea), c.oninput = it, u.onchange = it, p.onchange = it, f.onchange = it, m.oninput = it, l.oninput = function (t) {
            ...
            t instanceof HTMLElement ? e.appendChild(t) : "object" === w(t) ? st(e, t) : t && (e.innerHTML = t)
        }, st = function (t, e) {
            ...
            t.html ? (at(t.html, e), V(e, "block")) : t.text ? (e.textContent = t.text, V(e, "block")) : q(e), function (e) {
                for (var t, n = z(), o = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], i = function (t) {
                    t.placeholder && !e.inputPlaceholder || (t.placeholder = e.inputPlaceholder)
                }, r = 0; r < o.length; r++) {
                    var a = x[o[r]], s = T(n, a);
                    if (t = S(n, o[r])) {
                        for (var c in t.attributes) if (t.attributes.hasOwnProperty(c)) {
                    ...
                    s.className = a, e.inputClass && E(s, e.inputClass), e.customClass && E(s, e.customClass.input), q(s)
                }
                switch (e.input) {
                    case"text":
                    case"email":
                    ...
                    case"tel":
                    case"url":
                        t = T(n, x.input), "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : B(e.inputValue) || C('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(w(e.inputValue), '"')), i(t), t.type = e.input, V(t);
                        break;
                    case"file":
                        i(t = T(n, x.file)), t.type = e.input, V(t);
                        break;
                    case"range":
                        var d = T(n, x.range), p = d.querySelector("input"), f = d.querySelector("output");
                        p.value = e.inputValue, p.type = e.input, f.value = e.inputValue, V(d);
                        break;
                    case"select":
                        var m = T(n, x.select);
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var v = T(n, x.checkbox), b = S(n, "checkbox");
                        b.type = "checkbox", b.value = 1, b.id = x.checkbox, b.checked = Boolean(e.inputValue), v.querySelector("span").innerHTML = e.inputPlaceholder, V(v);
                        break;
                    case"textarea":
            ...
            }(t), y(z(), t.customClass, "content")
        }, lt = function () {
            for (var t = U(), e = 0; e < t.length; e++) q(t[e])
        }, dt = function () {
            for (var t = D(), e = window.getComputedStyle(t).getPropertyValue("background-color"), n = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), o = 0; o < n.length; o++) n[o].style.backgroundColor = e
        }, pt = function (i) {
            var r = K(), a = parseInt(null === i.currentProgressStep ? Ut.getQueueStep() : i.currentProgressStep, 10);
            i.progressSteps && i.progressSteps.length ? (V(r), r.innerHTML = "", a >= i.progressSteps.length && C("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), i.progressSteps.forEach(function (t, e) {
                var n = document.createElement("li");
                if (E(n, x["progress-step"]), n.innerHTML = t, e === a && E(n, x["active-progress-step"]), r.appendChild(n), e !== i.progressSteps.length - 1) {
                    var o = document.createElement("li");
                    E(o, x["progress-step-line"]), i.progressStepsDistance && (o.style.width = i.progressStepsDistance), r.appendChild(o)
                }
            })) : q(r)
        }, ft = function (t) {
            var e, n, o, i, r = $();
            y(r, t.customClass, "header"), pt(t), function (t) {
                if (lt(), t.type) if (dt(), -1 !== Object.keys(g).indexOf(t.type)) {
                    var e = D().querySelector(".".concat(x.icon, ".").concat(g[t.type]));
                    V(e), y(e, t.customClass, "icon"), t.animation && E(e, "swal2-animate-".concat(t.type, "-icon"))
                } else k('Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.type, '"'))
            }(t), function (t) {
                var e = W();
                if (!t.imageUrl) return q(e);
                V(e), e.setAttribute("src", t.imageUrl), e.setAttribute("alt", t.imageAlt), M(e, "width", t.imageWidth), M(e, "height", t.imageHeight), e.className = x.image, y(e, t.customClass, "image"), t.imageClass && E(e, t.imageClass)
            }(t), e = t, n = _(), j(n, e.title || e.titleText), e.title && at(e.title, n), e.titleText && (n.innerText = e.titleText), y(n, e.customClass, "title"), o = t, i = X(), y(i, o.customClass, "closeButton"), j(i, o.showCloseButton), i.setAttribute("aria-label", o.closeButtonAriaLabel)
        }, mt = function (t) {
            var e, n, o, i;
            e = t, n = D(), M(n, "width", e.width), M(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = x.popup, e.toast ? (E([document.documentElement, document.body], x["toast-shown"]), E(n, x.toast)) : E(n, x.modal), y(n, e.customClass, "popup"), "string" == typeof e.customClass && E(n, e.customClass), e.animation ? O(n, x.noanimation) : E(n, x.noanimation), function (t) {
                var e = I();
                if (e) {
                    if ("string" == typeof t.backdrop ? e.style.background = t.backdrop : t.backdrop || E([document.documentElement, document.body], x["no-backdrop"]), !t.backdrop && t.allowOutsideClick && C('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), t.position in x ? E(e, x[t.position]) : (C('The "position" parameter is not valid, defaulting to "center"'), E(e, x.center)), t.grow && "string" == typeof t.grow) {
                        var n = "grow-" + t.grow;
                        n in x && E(e, x[n])
                    }
                    y(e, t.customClass, "container"), t.customContainerClass && E(e, t.customContainerClass)
                }
            }(t), ft(t), ut(t), function (t) {
                var e = Y(), n = Z(), o = Q();
                if (t.showConfirmButton || t.showCancelButton ? V(e) : q(e), y(e, t.customClass, "actions"), j(n, t.showConfirmButton, "inline-block"), j(o, t.showCancelButton, "inline-block"), n.innerHTML = t.confirmButtonText, o.innerHTML = t.cancelButtonText, n.setAttribute("aria-label", t.confirmButtonAriaLabel), o.setAttribute("aria-label", t.cancelButtonAriaLabel), n.className = x.confirm, E(n, t.confirmButtonClass), t.customClass && E(n, t.customClass.confirmButton), o.className = x.cancel, E(o, t.cancelButtonClass), t.customClass && E(o, t.customClass.cancelButton), t.buttonsStyling) {
                    E([n, o], x.styled), t.confirmButtonColor && (n.style.backgroundColor = t.confirmButtonColor), t.cancelButtonColor && (o.style.backgroundColor = t.cancelButtonColor);
                    var i = window.getComputedStyle(n).getPropertyValue("background-color");
                    n.style.borderLeftColor = i, n.style.borderRightColor = i
                } else O([n, o], x.styled), n.style.backgroundColor = n.style.borderLeftColor = n.style.borderRightColor = "", o.style.backgroundColor = o.style.borderLeftColor = o.style.borderRightColor = ""
            }(t), o = t, i = J(), j(i, o.footer), o.footer && at(o.footer, i), y(i, o.customClass, "footer")
        };
    var gt = [], ht = function () {
            var t = D();
            t || Ut.fire(""), t = D();
            var e = Y(), n = Z(), o = Q();
            V(e), V(n), E([t, e], x.loading), n.disabled = !0, o.disabled = !0, t.setAttribute("data-loading", !0), t.setAttribute("aria-busy", !0), t.focus()
        }, vt = {}, bt = {
            title: "",
            titleText: "",
            text: "",
        ...
        wt = ["allowOutsideClick", "allowEnterKey", "backdrop", "focusConfirm", "focusCancel", "heightAuto", "keydownListenerCapture"],
        Ct = function (t) {
            ...
            isUpdatableParameter: function (t) {
                return -1 !== ["customClass", "title", "titleText", "text", "html", "type", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonClass", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonClass", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeigth", "imageAlt", "imageClass", "progressSteps", "currentProgressStep"].indexOf(t)
            },
            ...
            queue: function (t) {
                ...
                gt = t;
                var a = function (t, e) {
                    gt = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
                }, s = [];
                return new Promise(function (i) {
                    !function e(n, o) {
                        n < gt.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(gt[n]).then(function (t) {
        ...
        }), xt = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap};

    function St() {
        var t = xt.innerParams.get(this), e = xt.domCache.get(this);
        t.showConfirmButton || (q(e.confirmButton), t.showCancelButton || q(e.actions)), O([e.popup, e.actions], x.loading), e.popup.removeAttribute("aria-busy"), e.popup.removeAttribute("data-loading"), e.confirmButton.disabled = !1, e.cancelButton.disabled = !1
    }

    var At = function () {
        null === v.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (v.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = v.previousBodyPadding + function () {
    ...
    function Ot(t) {
        var e = I(), n = D(), o = xt.innerParams.get(this), i = Et.swalPromiseResolve.get(this), r = o.onClose,
            a = o.onAfterClose;
        if (n) {
            null !== r && "function" == typeof r && r(n), O(n, x.show), E(n, x.hide);
            var s = function () {
                et() ? Tt(a) : (new Promise(function (t) {
    ...
    var Ht = function (t) {
        var e = I(), n = D();
        null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), t.animation ? (E(n, x.show), E(e, x.fade), O(n, x.hide)) : O(n, x.fade), V(n), e.style.overflowY = "hidden", ct && !b(n, x.noanimation) ? n.addEventListener(ct, function t() {
            n.removeEventListener(ct, t), e.style.overflowY = "auto"
        }) : e.style.overflowY = "auto", E([document.documentElement, document.body, e], x.shown), t.heightAuto && t.backdrop && !t.toast && E([document.documentElement, document.body], x["height-auto"]), tt() && (t.scrollbarPadding && At(), function () {
            if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !b(document.body, x.iosfix)) {
                var t = document.body.scrollTop;
                document.body.style.top = -1 * t + "px", E(document.body, x.iosfix)
            }
        }(), "undefined" != typeof window && Pt() && (Lt(), window.addEventListener("resize", Lt)), p(document.body.children).forEach(function (t) {
            t === I() || function (t, e) {
                if ("function" == typeof t.contains) return t.contains(e)
            }(t, I()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")), t.setAttribute("aria-hidden", "true"))
        }), setTimeout(function () {
            e.scrollTop = 0
        })), et() || vt.previousActiveElement || (vt.previousActiveElement = document.activeElement), null !== t.onOpen && "function" == typeof t.onOpen && setTimeout(function () {
            t.onOpen(n)
        })
    }, It = {
    ...
    var Rt, Nt = Object.freeze({
        hideLoading: St, disableLoading: St, getInput: function (t) {
            var e = xt.innerParams.get(t || this);
            return S(xt.domCache.get(t || this).content, e.input)
        }, close: Ot, closePopup: Ot, closeModal: Ot, closeToast: Ot, enableButtons: function () {
            Mt(this, ["confirmButton", "cancelButton"], !1)
        }, disableButtons: function () {
            Mt(this, ["confirmButton", "cancelButton"], !0)
        }, enableConfirmButton: function () {
            n("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"), Mt(this, ["confirmButton"], !1)
        }, disableConfirmButton: function () {
            n("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"), Mt(this, ["confirmButton"], !0)
            ...
            e.validationMessage.style.marginLeft = "-".concat(n.getPropertyValue("padding-left")), e.validationMessage.style.marginRight = "-".concat(n.getPropertyValue("padding-right")), V(e.validationMessage);
            var o = this.getInput();
            o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedBy", x["validation-message"]), P(o), E(o, x.inputerror))
            ...
            return n("Swal.getProgressSteps()", "const swalInstance = Swal.fire({progressSteps: ['1', '2', '3']}); const progressSteps = swalInstance.params.progressSteps"), xt.innerParams.get(this).progressSteps
            ...
            var p = this;
            !function (t) {
                for (var e in t) Ct(e) || C('Unknown parameter "'.concat(e, '"')), t.toast && -1 !== wt.indexOf(e) && C('The parameter "'.concat(e, '" is incompatible with toasts')), kt(e) && n(e, kt(e))
            }(t);
            var f = s({}, bt, t);
            !function (e) {
                e.inputValidator || Object.keys(jt).forEach(function (t) {
                ...
                var t = D(), n = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
                (!t || t && n && t.parentNode !== n.parentNode) && rt(e)
            }(f), Object.freeze(f), xt.innerParams.set(this, f), vt.timeout && (vt.timeout.stop(), delete vt.timeout), clearTimeout(vt.restoreFocusTimeout);
            var m = {
                popup: D(),
                container: I(),
                content: z(),
            ...
            return new Promise(function (t) {
                ...
                Et.swalPromiseResolve.set(p, t), f.timer && (vt.timeout = new qt(function () {
                ...
                for (var c = function (e) {
                    f.showLoaderOnConfirm && g.showLoading(), f.preConfirm ? (p.resetValidationMessage(), Promise.resolve().then(function () {
                        ...
                        H(m.validationMessage) || !1 === t ? p.hideLoading() : n(void 0 === t ? e : t)
                    })) : n(e)
                }, e = function (t) {
                    var e = t.target, n = m.confirmButton, o = m.cancelButton, i = n && (n === e || n.contains(e)),
                        r = o && (o === e || o.contains(e));
                    switch (t.type) {
                        case"click":
                            if (i) if (p.disableButtons(), f.input) {
                                var a = function () {
                                    var t = p.getInput();
                                    if (!t) return null;
                                    switch (f.input) {
                            ...
                            } else c(!0); else r && (p.disableButtons(), s(g.DismissReason.cancel))
                    }
                ...
                if (m.closeButton.onclick = function () {
                    ...
                    m.popup.onmousedown = function () {
                        ...
                        r ? r = !1 : t.target === m.container && h(f.allowOutsideClick) && s(g.DismissReason.backdrop)
                    }
                }
                ...
                var a = function (t, e) {
                    for (var n = G(f.focusCancel), o = 0; o < n.length; o++) return (t += e) === n.length ? t = 0 : -1 === t && (t = n.length - 1), n[t].focus();
                    m.popup.focus()
                };
                if (vt.keydownHandlerAdded && (vt.keydownTarget.removeEventListener("keydown", vt.keydownHandler, {capture: vt.keydownListenerCapture}), vt.keydownHandlerAdded = !1), f.toast || (vt.keydownHandler = function (t) {
                    return function (t, e) {
                        if (e.stopKeydownPropagation && t.stopPropagation(), "Enter" !== t.key || t.isComposing) if ("Tab" === t.key) {
                            for (var n = t.target, o = G(e.focusCancel), i = -1, r = 0; r < o.length; r++) if (n === o[r]) {
                                i = r;
                                break
                            }
                            t.shiftKey ? a(i, -1) : a(i, 1), t.stopPropagation(), t.preventDefault()
                        } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === m.confirmButton && H(m.cancelButton) ? m.cancelButton.focus() : document.activeElement === m.cancelButton && H(m.confirmButton) && m.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== h(e.allowEscapeKey) || (t.preventDefault(), s(g.DismissReason.esc)); else if (t.target && p.getInput() && t.target.outerHTML === p.getInput().outerHTML) {
                            if (-1 !== ["textarea", "file"].indexOf(e.input)) return;
                            g.clickConfirm(), t.preventDefault()
                        }
                    }(t, f)
                }, vt.keydownTarget = f.keydownListenerCapture ? window : m.popup, vt.keydownListenerCapture = f.keydownListenerCapture, vt.keydownTarget.addEventListener("keydown", vt.keydownHandler, {capture: vt.keydownListenerCapture}), vt.keydownHandlerAdded = !0), p.enableButtons(), p.hideLoading(), p.resetValidationMessage(), f.toast && (f.input || f.footer || f.showCloseButton) ? E(document.body, x["toast-column"]) : O(document.body, x["toast-column"]), "select" === f.input || "radio" === f.input) {
                    var u = z(), l = function (t) {
                        return It[f.input](u, (e = t, n = [], "undefined" != typeof Map && e instanceof Map ? e.forEach(function (t, e) {
                            n.push([e, t])
                    ...
                    g.showLoading(), q(d), f.inputValue.then(function (t) {
                        d.value = "number" === f.input ? parseFloat(t) || 0 : t + "", V(d), d.focus(), p.hideLoading()
                    }).catch(function (t) {
                        k("Error in inputValue promise: " + t), d.value = "", V(d), d.focus(), p.hideLoading()
                    })
                }
                Ht(f), f.toast || (h(f.allowEnterKey) ? f.focusCancel && H(m.cancelButton) ? m.cancelButton.focus() : f.focusConfirm && H(m.confirmButton) ? m.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), m.container.scrollTop = 0
            })
        }, update: function (e) {
            var n = {};
            Object.keys(e).forEach(function (t) {
                Ut.isUpdatableParameter(t) ? n[t] = e[t] : C('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
            var t = s({}, xt.innerParams.get(this), n);
            mt(t), xt.innerParams.set(this, t), Object.defineProperties(this, {
                params: {
    ...
    function Dt() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && k("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), Rt = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    }, s(Dt.prototype, Nt), s(Dt, Bt), Object.keys(Nt).forEach(function (e) {
        Dt[e] = function () {
            var t;
            if (Rt) return (t = Rt)[e].apply(t, arguments)
        }
    }), Dt.DismissReason = t, Dt.version = "8.8.0";
    var Ut = Dt;
...
!function (t, e) {
        ...
        _reflowUI: function () {
            ...
            if (void 0 === this.options.errorsMessagesDisabled) {
                ...
                for (e = 0; e < t.added.length; e++) this._addError(t.added[e].assert.name, {
                    message: t.added[e].errorMessage, assert: t.added[e].assert
                });
            ...
            if (!1 !== this._trigger("submit")) {
                if (t) {
                    ...
                    0 === e.length && (e = h('<input class="parsley-synthetic-submit-button" type="hidden">').appendTo(this.$element)), e.attr({
                        name: t.getAttribute("name"), value: t.getAttribute("value")
                    })
                }
    ...
    w.prototype = {
        validate: function (t) {
            ...
            if (this.refresh(), !s || this._isInGroup(s)) return this.value = this.getValue(), this._trigger("validate"), (e = this.whenValid({
                force: n, value: this.value, _refreshed: !0
            }).always(function () {
                i._reflowUI()
            }).done(function () {
                i._trigger("success")
            ...
            return !1 === r && (r = h.Deferred().reject()), d.all([r]).fail(function (t) {
                i.validationResult instanceof Array || (i.validationResult = []), i.validationResult.push({
                    assert: e, errorMessage: "string" == typeof t && t
                })
            })
        }, getValue: function () {
            var t;
            ...
            return "number" === i ? this.addConstraint("type", ["number", {
                step: this.element.getAttribute("step") || "1", base: t || this.element.getAttribute("value")
    ...
    window.ParsleyValidator = {}, h.each("setLocale addCatalog addMessage addMessages getErrorMessage formatMessage addValidator updateValidator removeValidator hasValidator".split(" "), function (t, e) {
        ...
        window.ParsleyUI[a] = function (t, e, i, r, n) {
            ...
            return d.warnOnce("Accessing UI is deprecated. Call '".concat(a, "' on the instance directly. Please comment in issue 1073 as to your need to call this method.")), t[a](e, {
                message: i, assert: r, updateClass: s
            })
        }
    ...
    return h.listen = function (t, e) {
        ...
        requirementType: {
            "": "string", validator: "string", reverse: "boolean", options: "object"
