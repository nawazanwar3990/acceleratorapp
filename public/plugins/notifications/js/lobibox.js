...
//------------------------------------------------------------------------------
    ...
    var LobiboxBase = {
        ...
        /**
         * Set the text of messagebox
         *
         * @param {string} msg "new text of messagebox"
         * @returns {LobiboxBase}
         * @private
         */
...
//------------------------------------------------------------------------------
    ...
    LobiboxPrompt.prototype = $.extend({}, LobiboxBase, {
        ...
        isValid: function () {
            var me = this,
                $error = me.$el.find('.lobibox-input-error-text');

            if (me.$options.required && !me.getValue()){
                me.$input.addClass('invalid');
                if ($error.length === 0){
                    me.$el.find('.lobibox-body').append('<p class="lobibox-input-error-text">'+me.$options.errorMessage+'</p>');
                    me._position();
                    me.$input.focus();
                }
                return false;
        ...
        _afterShow: function () {
            ...
            if (me.$options.iconClass) {
                d.append($('<div class="lobibox-icon-wrapper"></div>')
                    .append('<i class="lobibox-icon ' + me.$options.iconClass + ' fs-1"></i>'))
                ;
            }
...
//------------------------------------------------------------------------------
        ...
        var _createTabControl = function (tabPaneId) {
            ...
            $('<a></a>', {
                'href': '#' + tabPaneId
            }).append('<i class="tab-control-icon ' + me.$options.icon + ' fs-1"></i>')
                .appendTo($li);
            return $li;
        };
        ...
        var _createNotify = function () {
            ...
            if (me.$options.img) {
                ...
                $innerIconEl.append('<div class="icon-el"><i class="' + me.$options.icon + ' fs-1"></i></div>');
            } else {
                $notify.addClass('without-icon');
            }
            // Create body, append title and text in body and append body in notification
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        messageHeight: 60,          // Notification text maximum height. This is not for notification itself, this is for <code>.lobibox-notify-msg</code>
