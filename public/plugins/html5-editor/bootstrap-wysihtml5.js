    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn dropdown-toggle" + size + "' data-bs-toggle='dropdown' href='javascript:void(0)'>" +
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal fade bs-example-modal-lg'>" +
                ...
                "<div class='modal-footer'>" +
                  "<a href='javascript:void(0)' class='btn btn-inverse' data-bs-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  "<a href='javascript:void(0)' class='btn btn-primary' data-bs-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
			  "</div>" +
              "</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade bs-example-modal-lg'>" +
				...
				"</div>" +
                "<div class='modal-footer'>" +
                  "<a href='javascript:void(0)' class='btn' data-bs-dismiss='modal'>" + locale.image.cancel + "</a>" +
                  "<a href='javascript:void(0)' class='btn  green btn-primary' data-bs-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
			  "</div>" +
              "</div>" +
